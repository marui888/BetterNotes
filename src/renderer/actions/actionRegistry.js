...
const actionCatalog = new Map([
  ['global.switchToVideo', { id: 'global.switchToVideo', label: 'Switch To Video', scope: 'global', description: 'Switch to video mode.', segmentedShortcut: true }],
  ['global.switchToPicture', { id: 'global.switchToPicture', label: 'Switch To Picture', scope: 'global', description: 'Switch to picture mode.', segmentedShortcut: true }],
  ['global.switchToText', { id: 'global.switchToText', label: 'Switch To Text', scope: 'global', description: 'Switch to text mode.', segmentedShortcut: true }],
  ['global.switchToManagement', { id: 'global.switchToManagement', label: 'Switch To Management', scope: 'global', description: 'Switch to management mode.', segmentedShortcut: true }],
  ...
  ['video.intoEditingFocus', { id: 'video.intoEditingFocus', label: 'Into Editing Focus', scope: 'video', description: 'Toggle focus between notes list and note content.' }],
  ['video.appendMark', { id: 'video.appendMark', label: 'Append Mark', scope: 'video', description: 'Append current start, end, and content as a note.', segmentedShortcut: true }],
  ['video.appendQuickMark', { id: 'video.appendQuickMark', label: 'Append Quick Mark', scope: 'video', description: 'Append quick mark from current playback position.', segmentedShortcut: true }],
  ['video.insertQuickBefore', { id: 'video.insertQuickBefore', label: 'Insert Quick Before', scope: 'video', description: 'Insert a quick mark before the selected note.', segmentedShortcut: true }],
  ['video.insertQuickAfter', { id: 'video.insertQuickAfter', label: 'Insert Quick After', scope: 'video', description: 'Insert a quick mark after the selected note.', segmentedShortcut: true }],
  ...
  ['video.toggleControlModeChord', { id: 'video.toggleControlModeChord', label: 'Toggle Control Mode', scope: 'video', description: 'Toggle video control shortcut mode.', segmentedShortcut: true }],
  ['video.toggleSubtitleHidden', { id: 'video.toggleSubtitleHidden', label: 'Hide Subs', scope: 'video', description: 'Show or hide rolling subtitles.', segmentedShortcut: true }],
  ['video.toggleVideoViewHidden', { id: 'video.toggleVideoViewHidden', label: 'Hide View', scope: 'video', description: 'Show or hide the video view.', segmentedShortcut: true }],
  ['video.toggleHvLayout', { id: 'video.toggleHvLayout', label: 'HV Layout', scope: 'video', description: 'Toggle the horizontal or vertical subtitle-center layout.', segmentedShortcut: true }],
  ...
  ['video.rollingFontSizeUp', { id: 'video.rollingFontSizeUp', label: 'Rolling Font Size Up', scope: 'video', description: 'Select the next larger rolling subtitle font size.' }],
  ['video.rollingFontSizeDown', { id: 'video.rollingFontSizeDown', label: 'Rolling Font Size Down', scope: 'video', description: 'Select the next smaller rolling subtitle font size.' }],
  ['video.videoOpacityDown', { id: 'video.videoOpacityDown', label: 'Video Opacity Down', scope: 'video', description: 'Reduce video view opacity.' }],
  ['video.videoOpacityUp', { id: 'video.videoOpacityUp', label: 'Video Opacity Up', scope: 'video', description: 'Increase video view opacity.' }],
  ['video.toggleView', { id: 'video.toggleView', label: 'Toggle View', scope: 'video', description: 'Cycle video view layout.', segmentedShortcut: true }],
  ...
  ['video.pickSub', { id: 'video.pickSub', label: 'Pick Sub', scope: 'video', description: 'Enter, exit, or confirm rolling subtitle selection.' }],
  ...
  ['image.nextImage', { id: 'image.nextImage', label: 'Next Image', scope: 'image', description: 'Select and load the next image after the configured delay.' }],
  ['image.saveNote', { id: 'image.saveNote', label: 'Save', scope: 'image', description: 'Save current picture note.' }],
  ['image.renameFile', { id: 'image.renameFile', label: 'Rename', scope: 'image', description: 'Rename selected picture file.' }],
  ['image.moveFile', { id: 'image.moveFile', label: 'Move', scope: 'image', description: 'Move selected picture file.' }],
  ['image.moveRenameFile', { id: 'image.moveRenameFile', label: 'Move&Re', scope: 'image', description: 'Rename and move selected picture file.' }],
  ['text.intoEditingFocus', { id: 'text.intoEditingFocus', label: 'Into Editing Focus', scope: 'text', description: 'Toggle focus between independent input and full line editor.' }],
  ...
  ['text.toggleView', { id: 'text.toggleView', label: 'Toggle View', scope: 'text', description: 'Toggle text words tab view.' }],
  ['text.replace', { id: 'text.replace', label: 'Replace', scope: 'text', description: 'Replace selected word with independent input.' }],
  ['text.replaceLine', { id: 'text.replaceLine', label: 'Replace Line', scope: 'text', description: 'Replace selected record with full line editor.' }],
  ['text.saveToSpecificFile', { id: 'text.saveToSpecificFile', label: 'SaveToSpecificFile', scope: 'text', description: 'Append independent input to the selected special text file.' }],
